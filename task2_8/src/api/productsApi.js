...
export async function getAllProducts() {
    // Updating productsData.imageURL with absolute URL (otherwise different pages paths break these relative imageURL paths)
    const baseURI = document.baseURI

    productsData.forEach(product => {
        let newImageURL = new URL(product.imageURL, baseURI).href.replace("/pages/", "/")
